...
就是三维向量距离公式向n维的推广，距离越近，则表示语义越相关，然后根据距离从小到大进行排序，选出top N条。
...
A社，Anthropic 就在他们的博客文章 [Introducing Contextual Retrieval](https://www.anthropic.com/news/contextual-retrieval) 中提出了一个概念，Contextual Retrieval，即上下文检索，这篇文章主要就是讲述的这种优化方式。
...
经过这三步的优化，RAG的查询失败率可以减少67%（5.7% -> 1.9%，数据来自上文 Anthropic 原文的评估）
